...
import ProcurementStaffDataService from "../../services/procumentstaff.service";
export default class AddTutorial extends Component {
  ...
  saveTutorial() {
    let ProcurementStaffData = {
      EmployeeName: this.state.SuplierName,
      Username: this.state.SuplierAddress,
      EmailAddress: this.state.SuplierContactNumber,
      TempPassword: this.state.SuplierAccountNumber,
      ConactNumber: this.state.ContactNumber,
    }
    console.log("dataa", ProcurementStaffData);
    ProcurementStaffDataService.create(ProcurementStaffData)
      .then(() => {
        ...
        <div className="container">
          ...
          {this.state.submitted ? (
            <div style={{ marginTop: '-900px' }}>
               ...
               <center> <h4>Procurement Staff Details Created!</h4>
            ...
            <div>
              <div className="form-group" style={{ marginTop: '-900px' }}>
                ...
                <Header as='h2' icon textAlign='center'>
                  ...
                  <Header.Content>Add New Procurement Staff</Header.Content>
                </Header>
