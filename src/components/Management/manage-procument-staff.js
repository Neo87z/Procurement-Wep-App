...
import ProcurementStaffDataSercice from "../../services/procumentstaff.service";
import Tutorial from "./procument-staff.data";
  ...
  render() {
    ...
    return (
        ...
        <Header as='h2' icon textAlign='center'>
                  ...
                  <Header.Content>Manage Procurement Staff</Header.Content>
                </Header>

          <h4> Procurement Staff List</h4>
        ...
        <div className="col-md-10" style={{ marginLeft: '150px' }}>
          {currentTutorial ? (
            ...
            <div>
              <br />
              <p>Please Click On A procument Staff To View Data...</p>
            </div>
          )}
        </div>
      </div>
